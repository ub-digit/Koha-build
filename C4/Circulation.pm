...
sub CanBookBeIssued {
    ...
    if ( $item_object->notforloan )
    {
        if(!C4::Context->preference("AllowNotForLoanOverride")){
            ...
            # any of the statusue in syspref BypassOnSiteCheckoutConfirmation AND on site checkout is ticked
            my @status_list = split(/\|/, Koha::Config::SysPrefs->find('BypassOnSiteCheckoutConfirmation')->value);
