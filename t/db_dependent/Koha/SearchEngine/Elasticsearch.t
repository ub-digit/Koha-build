...
- name: Title and author
  ...
  multiple: join
END
    t::lib::Mocks::mock_preference('SearchResultMARCExportCustomFormats', $custom_formats);
    $custom_formats = C4::Context->yaml_preference('SearchResultMARCExportCustomFormats');
