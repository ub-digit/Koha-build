...
sub search_result_export_custom_formats {
    my $export_custom_formats_pref = C4::Context->yaml_preference('SearchResultMARCExportCustomFormats') || [];
...
custom format defined in the "SearchResultMARCExportCustomFormats" syspref.
...
sub get_facetable_fields {
    ...
    my @search_field_names = qw( author gub-format itype location su-geo title-series subject ccode holdingbranch homebranch ln );
